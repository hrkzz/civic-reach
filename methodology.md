# Civic Reach: Sludge Audit Criteria and Methodology

Civic Reach audits and evaluates "Sludge" in administrative documents based on the behavioral science framework defined in the OECD (Organisation for Economic Co-operation and Development) 2024 report, "Fixing Frictions: ‘Sludge audits’ around the world".
...
- Audit Criteria:
    - Is critical information (deadlines, contact details, eligibility) buried within the text?
...
- Audit Criteria:
    - Does the document cause "Choice Overload" with too many options?
...
- Audit Criteria:
    - Is there an excessive use of bureaucratic "Jargon" or passive voice?
...
- Audit Criteria:
    - Is the "Tone of voice" coercive, overly bureaucratic, or cold?
